/**
 * index.ts — barrel re-export for the End-of-Chain effects system.
 *
...
export type { ParamMeta }    from './eoc-module.js';

export { EOCChain }          from './eoc-chain.js';
export type { NispsMode, ChainParamMeta, EOCChangeDetail } from './eoc-chain.js';
