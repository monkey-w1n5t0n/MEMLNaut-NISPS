 ...
 *
 * Deliberately a separate DRIVER from codegen/generate.ts (the mode-schema
 * pipeline): different schema dir, different meta-schema, different output
...
// ./lib.ts (ST12, shared with generate.ts).
